      ...
      <div className="w-full border-b border-gray-200 dark:border-gray-700 py-3 transform hover:scale-[1.01] transition-all">
        <div className="flex flex-col justify-between items-center">
          <div className="flex flex-col items-center">
            ...
            <div className="text-gray-300 dark:text-gray-400 text-left self-start">
              {channel}
            </div>
          </div>
          <div className="flex items-center flex-rowmt-2 sm:mt-0 w-full sm:w-auto justify-end	self-end">
