...
summary: 'A simple and minimalistic template to develop your Next.js application in a VS Code development container..'
image: '/static/images/next-js-devcontainer/banner.png'
---

<Image
  alt={`Next.js Devcontainer`}
  src={`/static/images/next-js-devcontainer/banner.png`}
  width={1200}
  height={630}
/>
...
Use Next.js with the portability of docker and the confort of VS Code in just a few steps.
...
<Image
  alt={`Usage Example`}
  src={`/static/images/next-js-devcontainer/example.gif`}
  width={1922}
  height={1042}
/>