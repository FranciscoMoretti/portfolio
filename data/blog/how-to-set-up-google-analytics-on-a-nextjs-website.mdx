...
summary: 'A guide to help you set up Google Analytics 4 in your Next.js website.'
image: '/static/images/how-to-set-up-google-analytics-on-a-nextjs-website/banner.png'
---


## Intro
Hey friends, this guide will help you set up Google Analytics 4 in your Next.js website. I wanted to learn about the demographic of people that visit [my personal site](http://www.franciscomoretti.com) and to keep track of the number of visitors over time.

I'm a big fan of [Vercel](https://vercel.com/) and that's why my site is hosted there, but their analytics solution is targeted toward commercial users. Google Analytics, on the other hand, gives individuals a ton of metrics for free. 

With these easy steps, I was able to set up Google Analytics on my site in a few minutes. 
...
2. Provide an account name. Configure the [data-sharing settings](https://support.google.com/analytics/answer/1011397) to control which data you share with Google.
...
![Data Stream options](/static/images/how-to-set-up-google-analytics-on-a-nextjs-website/data_stream_options.png)

1. Enter the URL of your primary website, e.g., "example.com", and a Stream name, e.g. "Example, Inc. (web stream)".
2. You have the option to enable or disable [enhanced measurement](https://support.google.com/analytics/answer/9216061). Enhanced measurement automatically collects page views and other events. 
...
2. In the *Property* column, check that you have your new Google Analytics 4 property selected, then click **Data Streams**, then **Web**. Click the data stream. Your "G-" ID appears at the upper right.

![The "G-" ID property](/static/images/how-to-set-up-google-analytics-on-a-nextjs-website/the_G_ID_property.png)
...
Finally, this step will connect the google analytics account with your site. As any ENV variable, there are two places where you need to set up this ENV variable. Let's go through each of them.
