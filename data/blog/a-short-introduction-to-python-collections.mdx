...
summary: "Use the right data structure for the job with the containers from Python's collections module."
...
Python has 4 collection data types: `list`, `tuple`, `sets` and `dictionary`. To solve some of the limitations of these types a built-in module named [`collections`](https://docs.python.org/3/library/collections.html#module-collections) has a much larger set of options. Let's go through some of these specialized data structures in detail.

A collection can be defined as a container data type. They have different characteristics based on the `declaration` and the `usage`.
...
- Indexed
- [`ChainMap` docs](https://docs.python.org/3/library/collections.html#collections.ChainMap)
...
- Ordered
- [`OrderedDict` docs](https://docs.python.org/3/library/collections.html#collections.OrderedDict)
...
- [`defaultdict` docs](https://docs.python.org/3/library/collections.html#collections.defaultdict)
...
- [`UserDict` docs](https://docs.python.org/3/library/collections.html#collections.UserDict)
...
- [`UserList` docs](https://docs.python.org/3/library/collections.html#collections.UserList)
...
- [ UserString` docs](https://docs.python.org/3/library/collections.html#userstring-objects)