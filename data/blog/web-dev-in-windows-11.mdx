...
summary: "How to set up your web development environment with WSL2 in Windows 11 to run a Next.js example."
...
This tutorial  was created in Windows 11 but you can use any of the following Windows versions:
...
## Conclusion
This is a tutorial that set up many different tools. From Windows to Linux though VS Code and with the Terminal. You end up with a Next.js blog application from one of the hottest frameworks at the moment and with a clean setup to create other applications.
