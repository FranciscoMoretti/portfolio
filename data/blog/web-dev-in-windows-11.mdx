...
image: '/static/images/web-dev-in-windows-11/windows_next_js_vs_code.png'
---

<Image
  alt={`Windows VS Code for Next.js`}
  src={`/static/images/web-dev-in-windows-11/windows_next_js_vs_code.png`}
  width={1200}
  height={630}
/>
